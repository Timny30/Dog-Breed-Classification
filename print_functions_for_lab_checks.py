...
# REVISED DATE: 08/26/2026    <=(Date Revised - if any)                         
...
def check_calculating_results(results_dic, results_stats_dic):
    ...
    if results_stats_dic is None:
        ...
        if n_pet_dog > 0: # adding conditional statement for preventing zero division error
        ...
        if n_pet_notd > 0: # adding conditional statement for preventing zero division error
