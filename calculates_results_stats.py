...
def calculates_results_stats(results_dic):
        ...
        #Initalize key and values within result statistic dictionary
        ...
        for image, value in results_dic.items():

                 # calculate the total number of match between pet & classifier labels
                if value[2] == 1:
                ...
                # Pet Image is a dog: count number of dog images
                if value[3] == 1:
                        results_stats_dic["n_dogs_img"] += 1

                        if value[4] == 1: # count number of correct classified dog images
                                results_stats_dic["n_correct_dogs"] += 1

                else:
                        results_stats_dic["n_notdogs_img"] += 1 # Image is not a dog: count number of non dog images
                        if value[4] == 0: # count number of incorrect classified dog images
